...
LsDeconv(...
    "X:\20230624_SM230223_05_LS_15x_800z_Double_MORF_B4\test", ...
    400, ... % dxy (nm)
    800, ... % dz (nm)
    25,   ... % numit
    0.40, ... % NA
    ...
    [1.0, 1.0, 1.5], ... % x y z sigma of the 3D gaussian filter applied before deconvolution. filter_size = ceil(sigma * 4 + 1)
    [3, 3, 9], ... % filter_size
    ...
    1,    ... % convert to 8-bit
    "X:\cache_deconvolution_b4" ... % cache drive (optional)
);