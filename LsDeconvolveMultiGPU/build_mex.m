...
function build_mex(debug)
    ...
    if ~isfile(stamp)
        ...
        args = [ ...
          ...
          sprintf('-DCMAKE_C_FLAGS_RELEASE="-O3 -march=native -fomit-frame-pointer -flto=%d -fPIC"', ncores) ...
        ];
    ...
    if ~isfile(stamp)
        ...
        args = sprintf([ ...
          ...
          '-DCMAKE_C_FLAGS_RELEASE="-O3 -march=native -flto=%d -fomit-frame-pointer -fPIC" ', ...
          '-DCMAKE_CXX_FLAGS_RELEASE="-O3 -march=native -flto=%d -fomit-frame-pointer -fPIC"' ...
        ], ...
    ...
    if ispc
        ...
        if debug
            ...
            mex_cpu = {'-R2018a', ...
              sprintf(  'CFLAGS="$CFLAGS -O3 -march=native -fomit-frame-pointer -flto=%d"'  , ncores), ...
              sprintf('CXXFLAGS="$CXXFLAGS -O3 -march=native -fomit-frame-pointer -flto=%d"', ncores), ...
    ...
    if debug
      ...
      nvccflags = sprintf('NVCCFLAGS="$NVCCFLAGS -Xcompiler -march=native -Xcompiler -fomit-frame-pointer -flto=%d"', ncores);
    end
