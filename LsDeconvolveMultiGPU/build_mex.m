    ...
    if ~isfile(t_stamp)
        ...
        if isWin
            args = [cmake_common_flags_tiff, ...
                '-DLZ4=ON', ...
                sprintf('-DLZ4_INCLUDE_DIR=%s', unixify(fullfile(lz4_inst,'include'))), ...
                sprintf('-DLZ4_LIBRARY=%s',     unixify(fullfile(lz4_inst,'lib','lz4.lib'))), ...
            ...
            args = [cmake_common_flags_tiff, ...
                '-DLZ4=ON', ...
                sprintf('-DLZ4_INCLUDE_DIR=%s', unixify(fullfile(lz4_inst,'include'))), ...
                sprintf('-DLZ4_LIBRARY=%s',     unixify(fullfile(lz4_inst,'lib','liblz4.a'))), ...
