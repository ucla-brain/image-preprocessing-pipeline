...
def main():
    ...
    parser.add_argument('--fibermetric-alpha', type=float, default=0.0165,
    ...
    parser.add_argument('--fibermetric-beta', type=float, default=0.6507,
    ...
    parser.add_argument('--fibermetric-gamma', type=float, default=0.0958,
