...
def get_voxel_sizes(is_mip):
    ...
    voxel_size_z = ask_for_a_number_in_range(
        ...
        f"{PrintColors.BLUE}hint: z-step is {'800' if is_mip else 'typically 0.8'} µm for the "
...
def main(source_path):
    ...
    objective, voxel_size_x, voxel_size_y, voxel_size_z, tile_size = get_voxel_sizes(stitch_mip)
